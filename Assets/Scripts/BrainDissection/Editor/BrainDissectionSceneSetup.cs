...
public static class BrainDissectionSceneSetup
{
        ...
        BrainDissectionUI bridge)
    {
        ...
        var toolStatusGO = MakeLabel("ToolStatus", main.transform, new Vector2(0, 172), new Vector2(700, 28),
            "Gloves: --     Knife: --     Tweezers: --", 14, FontStyle.Normal, TextGreen, TextAnchor.MiddleCenter, font);
        ...
        var statusMsgGO = MakeLabel("StatusMessage", main.transform, new Vector2(0, 140), new Vector2(700, 35),
            "Please equip your gloves to begin the lab.", 16, FontStyle.Italic, TextDim, TextAnchor.MiddleCenter, font);
        ...
        MakeLabel("OpacityLbl", ctrlPanel.transform, new Vector2(-220, ctrlRow3), new Vector2(150, 28),
            "Opacity:", 16, FontStyle.Normal, TextDim, TextAnchor.MiddleRight, font);
        ...
        MakeLabel("Instructions", main.transform, new Vector2(0, -225), new Vector2(700, 25),
            "Gloves  >  Cut with knife  >  Grip to rotate  >  Tweezers + Trigger to inspect region", 12,
        ...
        var details = MakePanel("DetailsPanel", root, new Vector2(0, 0), new Vector2(780, 400), PanelBg);
        details.SetActive(false);
        uiCtrl.detailsPanel = details;

        MakeLabel("DTitle", details.transform, new Vector2(0, 155), new Vector2(650, 45),
            "Region Name", 28, FontStyle.Bold, TextWhite, TextAnchor.MiddleCenter, font);
        uiCtrl.regionTitleTextLegacy = details.transform.Find("DTitle").GetComponent<Text>();
        MakeAccentLine(details.transform, new Vector2(0, 127), new Vector2(550, 3));

        var shortD = MakeLabel("ShortDesc", details.transform, new Vector2(0, 85), new Vector2(650, 50),
            "", 17, FontStyle.Italic, TextDim, TextAnchor.UpperCenter, font);
        uiCtrl.regionShortDescriptionTextLegacy = shortD.GetComponent<Text>();

        var longD = MakeLabel("DetailedDesc", details.transform, new Vector2(0, 10), new Vector2(650, 110),
            "", 15, FontStyle.Normal, TextWhite, TextAnchor.UpperLeft, font);
        uiCtrl.regionDetailedDescriptionTextLegacy = longD.GetComponent<Text>();

        MakeBtn("PutBack", details.transform, new Vector2(-150, -140), new Vector2(220, 50),
            "Put Back Into Brain", BtnGreen, bridge, "OnPutBackClicked", font);
        MakeBtn("DZoomIn", details.transform, new Vector2(80, -140), new Vector2(120, 50),
            "Zoom +", BtnBlueBright, bridge, "OnZoomInClicked", font);
        MakeBtn("DZoomOut", details.transform, new Vector2(220, -140), new Vector2(120, 50),
    ...
    static void MakeBtn(string name, Transform parent, Vector2 pos, Vector2 size,
