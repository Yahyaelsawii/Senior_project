...
public static class StartMenuSetup
{
    ...
    public static void SetupStartMenu()
    {
        ...
        // ---- 14. Create TutorialScene if it doesn't exist ----
        CreateTutorialScene();

        EditorUtility.SetDirty(systemGO);
        EditorUtility.SetDirty(canvasGO);
        EditorSceneManager.MarkSceneDirty(systemGO.scene);
        Debug.Log("[Start Menu] Setup complete. Login, Menu, Options, Doors, Timer, Keyboard ready.");
        Debug.Log("[Start Menu] IMPORTANT: Add 'TutorialScene' to File > Build Settings > Scenes In Build.");
    }
        ...
        LoginManager loginMgr, VRKeyboardManager kbMgr, OptionsController optCtrl, SessionTimer timer)
    {
        ...
        // Name field
        MakeLabel("NameLabel", loginPanel.transform, new Vector2(-180, 30), new Vector2(100, 30),
            "Name:", 18, FontStyle.Bold, TextWhite, TextAnchor.MiddleRight, font);
        var nameField = MakeInputField("NameInput", loginPanel.transform, new Vector2(60, 30), new Vector2(320, 45),
        ...
        // Age field
        MakeLabel("AgeLabel", loginPanel.transform, new Vector2(-180, -35), new Vector2(100, 30),
            "Age:", 18, FontStyle.Bold, TextWhite, TextAnchor.MiddleRight, font);
        var ageField = MakeInputField("AgeInput", loginPanel.transform, new Vector2(60, -35), new Vector2(320, 45),
            "Enter your age...", font);
        loginMgr.ageInputField = ageField.GetComponent<InputField>();
        kbMgr.RegisterInputField(loginMgr.ageInputField);

        // Submit button
        var submitBtn = MakeButton("SubmitBtn", loginPanel.transform, new Vector2(0, -120), new Vector2(250, 55),
            "LOGIN", BtnGreen, font);
        ...
        // Options button
        var optBtn = MakeButton("OptionsBtn", mainMenuPanel.transform, new Vector2(0, -95), new Vector2(320, 50),
        ...
        var backBtn = MakeButton("BackToLoginBtn", mainMenuPanel.transform, new Vector2(0, -170), new Vector2(320, 50),
        ...
        // Contrast
        MakeLabel("ContrastLabel", optionsPanel.transform, new Vector2(-200, 10), new Vector2(160, 30),
            "Contrast:", 18, FontStyle.Normal, TextWhite, TextAnchor.MiddleRight, font);
        var contrastSlider = MakeSlider("ContrastSlider", optionsPanel.transform,
            new Vector2(60, 10), new Vector2(300, 30), -100f, 100f, 0f);
        optCtrl.contrastSlider = contrastSlider.GetComponent<Slider>();
    ...
    static void BuildHUDTimer(SessionTimer timer)
    {
        ...
        // Create a world-space canvas that will be parented to the camera offset
        var hudGO = new GameObject("SessionHUDCanvas");

        // Try to find the XR camera to parent the HUD to
        ...
        bgPanel.AddComponent<Image>().color = new Color(0.04f, 0.04f, 0.08f, 0.75f);

        // Timer text
        var textGO = new GameObject("TimerText");
        textGO.transform.SetParent(bgPanel.transform, false);
    ...
    static void CreateTutorialScene()
    {
        ...
        {
            Debug.Log("[Start Menu] TutorialScene already exists.");
            return;
        }
        ...
        Debug.Log("[Start Menu] TutorialScene created at " + scenePath);
        Debug.Log("[Start Menu] REMINDER: Add TutorialScene to File > Build Settings > Scenes In Build.");
    }
